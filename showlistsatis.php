...
if (!isset($_SESSION['user_id']) && !isset($_SESSION['admin_id'])) {
    ...
    $result = $conn->query("SELECT m.* FROM tb_member m JOIN project p ON m.member_id = p.member_id JOIN tb_satisfied sa ON p.project_id = sa.project_id WHERE sa.sati_id = $id");
    $count = count($result->fetchAll());
    $result->execute();
}
