...
const update1Buttons = () => {
    ...
    document.getElementById('section1addbtn').classList.toggle('hidden', visibleRows >= 5);
...
const update2Buttons = () => {
    ...
    document.getElementById('section2addbtn').classList.toggle('hidden', visibleRows >= 5);
...
const update3Buttons = () => {
    ...
    document.getElementById('section3addbtn').classList.toggle('hidden', visibleRows >= 5);
...
const update4Buttons = () => {
    ...
    document.getElementById('section4addbtn').classList.toggle('hidden', visibleRows >= 5);
