...
/*---------------------------------------------------------------- */
    let checkitA = ".ideditA" + idp.toString();
    let checkitB = ".idedit1A" + idp.toString();
    let check0 = document.querySelector(checkitA);
    let check1 = document.querySelector(checkitB);

    let checkitC = ".idedit14" + idp.toString();
    let checkitD = ".idedit15" + idp.toString();
    let checkitE = ".idedit16" + idp.toString();
    let check3 = document.querySelector(checkitC);
    let check4 = document.querySelector(checkitD);
    let check5 = document.querySelector(checkitE);
 
    if(checkvalue[0] === check0.textContent){
        rad2[0].click();
    }else if(checkvalue[0] === check1.textContent){
        rad2[1].click();
    }

    if(checkvalue[1] === check3.textContent){
        rad3[0].click();
    }else if(checkvalue[1] === check4.textContent){
        rad3[1].click();
    }else if(checkvalue[1] === check5.textContent){
        rad3[2].click();
    }
