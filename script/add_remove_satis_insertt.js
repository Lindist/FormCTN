...
const section1add = () => {
    ...
    const section1tr4 = document.getElementById('section1tr4');
    ...
    const textarea4 = document.getElementById('section1tr4td');
    ...
    } else if (section1tr4.classList.contains('hidden')) {
        section1tr4.classList.remove('hidden');
    ...
    if (!section1tr4.classList.contains('hidden')) {
...
const section1remove = () => {
    ...
    if (!section1tr4.classList.contains('hidden')) {
        section1tr4.classList.add('hidden');
...
const section2add = () => {
    ...
    if (section2tr1.classList.contains('hidden')) {
        ...
        textarea3.disabled = false;
    } else if (section2tr4.classList.contains('hidden')) {
        section2tr4.classList.remove('hidden');
        textarea4.disabled = false;
    }
...
const section3add = () => {
    ...
    const section3tr4 = document.getElementById('section3tr4');
...
const section4add = () => {
    ...
    const section4tr4 = document.getElementById('section4tr4');
