                            ...
                            <tbody>
                                <?php for ($b = 0; $b < count($feature_ex[$index]); $b++) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-control1" id="format" rows="3"><?php echo $feature_ex[$index][$b]; ?></div>
                                        </td>
                                        <td>
                                            <div class="form-control1" id="format" rows="3"><?php echo $setfeature_ex[$index][$b]; ?></div>
                                        </td>
                                        <td>
                                            <div class="form-control1" id="format" rows="3"><?php echo $resultfilled_ex[$index][$b]; ?></div>
                                        </td>
                                        <td>
                                            <div class="form-control1" id="format" rows="3"><?php echo $comparefilled_ex[$index][$b]; ?></div>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
