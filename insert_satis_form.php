        ...
        <form action="insert_satis.php" method="POST">
            ...
            <div class="mb-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-2">
                    ...
                    <?php $i = 1; ?>
                    <select name="sati_info" id="sati_info" class="border border-gray-300 rounded px-3 py-2 w-full">
                        <?php while ($i <= 10) : ?>
                            <option value="<?= $i ?>"><?= $i ?></option>
                        <?php $i++;
                        endwhile; ?>
                    </select>
                    <button type="button" id="addinfo" onclick="" class="bg-green-500 text-white py-2 rounded hover:bg-green-600">เพิ่ม</button>
                ...
                document.getElementById('addinfo').addEventListener('click', function() {
                    var selectElement = document.getElementById('sati_info');
                    var selectedValue = parseInt(selectElement.value, 10); // Convert to integer
                    ...
                    var numberOfBlocks = Math.min(selectedValue, 10);
                    ...
                    for (var i = 0; i < numberOfBlocks; i++) {
                        ...
                        newBlock.innerHTML = `
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-2" id="info-container_${i + 1}">
                                <div class="flex-col items-center justify-center">
                                    <input type="text" class="border border-gray-300 rounded px-3 py-2 my-1 sm:w-96" name="sati_info[]" value="" required>
                                    <button type="button" id="addinfo_${i + 1}" class="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600 ml-2">เพิ่มข้อมูลพื้นฐานที่ ${i + 1}</button>
                                </div>
                        ...
                        // Add event listener for each "เพิ่มข้อมูลพื้นฐานที่" button
                        document.getElementById(`addinfo_${i + 1}`).addEventListener('click', function() {
                            var containerId = this.id.replace('addinfo_', '');
                            var subInfoSection = document.getElementById(`sub-info_${containerId}`);
                            var newInput = document.createElement('input');
                            newInput.required;
                            newInput.type = 'text';
                            newInput.className = 'border border-gray-300 rounded px-3 py-2 my-1 sm:w-96';
                            newInput.name = `sati_info_${containerId}[]`;

                            var newButton = document.createElement('button');
                            newButton.type = 'button';
                            newButton.className = 'bg-red-500 text-white py-2 px-4 rounded hover:bg-red-600 ml-2';
                            newButton.textContent = 'ลบ'; // Add text to the button

                            newButton.addEventListener('click', function() {
                                newInput.remove(); // Remove the input when the "ลบ" button is clicked
                                newButton.remove(); // Remove the "ลบ" button itself
                            });
                ...
                <div>
                    ...
                    <table class="w-full border border-gray-300 text-center my-3">
                        ...
                        <tbody>
                            <tr class="odd:bg-white even:bg-gray-100">
                                ...
                                <td class="border border-gray-300 py-2"><textarea name="ur_topic[]" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1" required></textarea></td>
                            ...
                            <tr class="odd:bg-white even:bg-gray-100 hidden" id="section1tr1">
                                ...
                                <td class="border border-gray-300 py-2"><textarea name="ur_topic[]" disabled id="section1tr1td" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1" required></textarea></td>
                            ...
                            <tr class="odd:bg-white even:bg-gray-100 hidden" id="section1tr2">
                                ...
                                <td class="border border-gray-300 py-2"><textarea name="ur_topic[]" disabled id="section1tr2td" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1" required></textarea></td>
                            ...
                            <tr class="odd:bg-white even:bg-gray-100 hidden" id="section1tr3">
                                ...
                                <td class="border border-gray-300 py-2"><textarea name="ur_topic[]" disabled id="section1tr3td" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1" required></textarea></td>
                            ...
                            <tr class="odd:bg-white even:bg-gray-100 hidden" id="section1tr4">
                                ...
                                <td class="border border-gray-300 py-2"><textarea name="ur_topic[]" disabled id="section1tr4td" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1" required></textarea></td>
                    ...
                    <table class="w-full border border-gray-300 text-center my-3">
                        ...
                        <tbody>
                            <tr class="odd:bg-white even:bg-gray-100">
                                <td class="border border-gray-300 py-2 text-center">1</td>
                                <td class="border border-gray-300 py-2"><textarea name="fun_topic[]" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1 flex items-center" required></textarea></td>
                            ...
                            <tr class="odd:bg-white even:bg-gray-100 hidden" id="section2tr1">
                                <td class="border border-gray-300 py-2 text-center">2</td>
                                <td class="border border-gray-300 py-2"><textarea name="fun_topic[]" disabled id="section2tr1td" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1 flex items-center" required></textarea></td>
                            ...
                            <tr class="odd:bg-white even:bg-gray-100 hidden" id="section2tr2">
                                <td class="border border-gray-300 py-2 text-center">3</td>
                                <td class="border border-gray-300 py-2"><textarea name="fun_topic[]" disabled id="section2tr2td" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1 flex items-center" required></textarea></td>
                            ...
                            <tr class="odd:bg-white even:bg-gray-100 hidden" id="section2tr3">
                                <td class="border border-gray-300 py-2 text-center">4</td>
                                <td class="border border-gray-300 py-2"><textarea name="fun_topic[]" disabled id="section2tr3td" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1 flex items-center" required></textarea></td>
                            ...
                            <tr class="odd:bg-white even:bg-gray-100 hidden" id="section2tr4">
                                <td class="border border-gray-300 py-2 text-center">5</td>
                                <td class="border border-gray-300 py-2"><textarea name="fun_topic[]" disabled id="section2tr4td" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1 flex items-center" required></textarea></td>
                    ...
                    <table class="w-full border border-gray-300 text-center my-3">
                        ...
                        <tbody>
                            <tr class="odd:bg-white even:bg-gray-100">
                                <td class="border border-gray-300 py-2 text-center">1</td>
                                <td class="border border-gray-300 py-2"><textarea name="uf_topic[]" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1 flex items-center" required></textarea></td>
                            ...
                            <tr class="odd:bg-white even:bg-gray-100 hidden" id="section3tr1">
                                <td class="border border-gray-300 py-2 text-center">2</td>
                                <td class="border border-gray-300 py-2"><textarea name="uf_topic[]" disabled id="section3tr1td" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1 flex items-center" required></textarea></td>
                            ...
                            <tr class="odd:bg-white even:bg-gray-100 hidden" id="section3tr2">
                                <td class="border border-gray-300 py-2 text-center">3</td>
                                <td class="border border-gray-300 py-2"><textarea name="uf_topic[]" disabled id="section3tr2td" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1 flex items-center" required></textarea></td>
                            ...
                            <tr class="odd:bg-white even:bg-gray-100 hidden" id="section3tr3">
                                <td class="border border-gray-300 py-2 text-center">4</td>
                                <td class="border border-gray-300 py-2"><textarea name="uf_topic[]" disabled id="section3tr3td" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1 flex items-center" required></textarea></td>
                            ...
                            <tr class="odd:bg-white even:bg-gray-100 hidden" id="section3tr4">
                                <td class="border border-gray-300 py-2 text-center">5</td>
                                <td class="border border-gray-300 py-2"><textarea name="uf_topic[]" disabled id="section3tr4td" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1 flex items-center" required></textarea></td>
                    ...
                    <table class="w-full border border-gray-300 text-center my-3">
                        ...
                        <tbody>
                            <tr class="odd:bg-white even:bg-gray-100">
                                <td class="border border-gray-300 py-2 text-center">1</td>
                                <td class="border border-gray-300 py-2"><textarea name="ss_topic[]" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1 flex items-center" required></textarea></td>
                            ...
                            <tr class="odd:bg-white even:bg-gray-100 hidden" id="section4tr1">
                                <td class="border border-gray-300 py-2 text-center">2</td>
                                <td class="border border-gray-300 py-2"><textarea name="ss_topic[]" disabled id="section4tr1td" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1 flex items-center" required></textarea></td>
                            ...
                            <tr class="odd:bg-white even:bg-gray-100 hidden" id="section4tr2">
                                <td class="border border-gray-300 py-2 text-center">3</td>
                                <td class="border border-gray-300 py-2"><textarea name="ss_topic[]" disabled id="section4tr2td" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1 flex items-center" required></textarea></td>
                            ...
                            <tr class="odd:bg-white even:bg-gray-100 hidden" id="section4tr3">
                                <td class="border border-gray-300 py-2 text-center">4</td>
                                <td class="border border-gray-300 py-2"><textarea name="ss_topic[]" disabled id="section4tr3td" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1 flex items-center" required></textarea></td>
                            ...
                            <tr class="odd:bg-white even:bg-gray-100 hidden" id="section4tr4">
                                <td class="border border-gray-300 py-2 text-center">5</td>
                                <td class="border border-gray-300 py-2"><textarea name="ss_topic[]" disabled id="section4tr4td" class="w-full h-28 sm:h-16 border border-gray-300 rounded px-2 py-1 flex items-center" required></textarea></td>
                ...
                <textarea disabled class="p-2 text-lg text-gray-900 border border-gray-300 rounded bg-gray-50 w-full" name="sati_comment" id="" cols="30" rows="10" placeholder="ไม่จำเป็นต้องกรอก . . . . ." required></textarea> -->
